// This code is modyfication of TrackballControls controller, but in this moment is not used
import {
	EventDispatcher,
	MOUSE,
	// Quaternion,
...
var TrackballControls = function ( object, domElement ) {
    ...
    var moveDirection = new Vector3(),
      ...
      angle = moveDirection.length();
        ...
        _eye.add(moveDirection.multiplyScalar( 100 ))
    ...
    //_eye będzie wektorem określającym kierunek od środka (A-B). Jeżeli nic nie zmieniamy to odległość od camera.position
